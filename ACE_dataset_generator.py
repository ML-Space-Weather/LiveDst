...
url_ACE_B = "ac_h0_mfi.csv?time,BGSEc._1,BGSEc._2,BGSEc._3,BGSM._1,BGSM._2,BGSM._3"
...
url_clu = [url_dst, url_F107, url_ACE_B, url_ACE_SW_realtime] 
name = ['Dst', 'F107', 'B', 'SW']
...
df_clu = []
for idx, name_t in enumerate(name):
